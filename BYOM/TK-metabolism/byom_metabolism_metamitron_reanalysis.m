...
DATA{1} = [0.50    1	1   1
0         0.00	0.00	0.00
0.025	28.72	64.05	35.22
0.05	57.28	54.34	64.17
0.1	75.79	56.53	71.34
0.2	69.45	65.65	66.22
0.4	53.36	40.44	92.02
0.8	48.32	42.59	40.65
1.4	26.36	10.68	2.93
1.425	5.44	4.97	4.55
1.45	2.51	3.12	1.11
1.5	0.69	0.51	0.38
1.6	0.00	0.19	0.00
1.8	0.00	0.00	0.00
...
DATA{2} = [0.50    1	1   1
0           0.00	0.00	0.00
0.025	5.01	5.74	5.63
0.05	11.45	11.86	12.51
0.1	22.40	18.01	21.94
0.2	46.31	35.15	50.49
0.4	62.10	41.45	93.55
0.8	68.32	51.78	57.03
1.4	51.51	31.34	15.06
1.425	34.23	44.65	36.40
1.45	36.86	55.11	32.68
1.5	31.64	31.17	25.58
1.6	13.14	11.17	8.43
1.8	1.45	1.26	1.10
2.2	0.66	0.65	0.53
2.8	0.24	0.30	0.17
...
par.ke          = [53.37               1   1        100     2];  % elimination rate constant, d-1
par.ku          = [23.09                1   1        100    2];  % uptake rate constant, L/kg/d

par.km          = [7.518               1   1           20       2];  % 1stBTP biotransformation rate constant [d-1]
par.kem         = [6.666               1   1           20       2];  % 1stBTP elimination rate constant [d-1]
