...
DATA{1} = [0.50    1	1   1
0	0	0	0
0.025	5.241	7.043	5.957
0.05	14.087	10.624	12.596
0.1	14.287	10.801	13.900
0.2	10.783	11.222	12.565
0.4	12.128	9.304	11.938
0.8	8.075	11.058	9.335
1.4	7.509	5.529	4.832
1.425	2.145	1.717	2.506
1.45	2.036	3.260	2.541
1.5	1.242	1.016	0.816
1.6	0.104	0.139	0.385
1.8	0.000	0.132	0.165
2.2	0.203	0.387	0.082
2.8	0.105	0.000	0.000
...
DATA{2} = [0.50    1	1   1
0	0	0	0
0.025	1.178	1.261	0.680
0.05	1.715	1.011	2.188
0.1	1.503	1.106	1.621
0.2	0.450	1.194	0.649
0.4	1.681	0.534	0.000
0.8	3.230	0.952	1.039
1.4	1.179	0.435	0.866
1.425	0.257	0.495	0.229
1.45	0.039	0.456	0.454
1.5	0.259	0.037	0.029
1.6	0.016	0.012	0.014
1.8	0.289	0.295	0.367
2.2	0.269	0.364	0.269
2.8	0.375	0.387	0.327
...
par.ke          = [5.724               1   0.001        50     2];  % elimination rate constant, d-1
par.ku          = [9.465                1   0.1        80    2];  % uptake rate constant, L/kg/d

par.km          = [26.81               1   1          100       2];  % 1stBTP biotransformation rate constant [d-1]
par.kem         = [249.8               1    1           250     2];  % 1stBTP elimination rate constant [d-1]
...
glo.stiff      = 2; % 0 = use ode45 with very strict tolerances (default, non-stiff mode); 2 = use ode15s for experiments with long time (i.e. more than one week) or imbalanced paramters
