...
par.ke          = [138.4            1   1         500    2];  % elimination rate constant, d-1
par.ku          = [21.31             1   1        50    2];  % uptake rate constant, L/kg/d

par.km          = [36.73                1   10           100       2];  % 1stBTP biotransformation rate constant [d-1]
par.kem         = [39.67                1   10           100      2];  % 1stBTP elimination rate constant [d-1]
